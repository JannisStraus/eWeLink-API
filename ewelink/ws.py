...
from typing import AnyStr, TypedDict, Any
    ...
    async def poll_event(self):
        try:
            while self.ws and not self.ws.closed:
                ...
                elif raw_msg.type in (aiohttp.WSMsgType.CLOSE, aiohttp.WSMsgType.CLOSING, aiohttp.WSMsgType.CLOSED):
                    break
                ...
                if 'error' in msg and 'params' not in msg:
                    ...
                    if not msg['error'] and 'query' in self._futures and self._futures['query']:
